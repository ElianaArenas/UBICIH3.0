    ...
    <div class="cat-news">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <p>Proyecto creado para las asignaturas de interacción hombre computador (HCI) e informatica biomedica
                        empleando gamificación, destinado a estudiantes de medicina para realizar la simulación de algunos
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 tn-center">
                    <iframe src="https://elianaarenas.github.io/UBICIHWEB/" title="juego" width="100%" height="650"></iframe>
                </div>
            </div>
        </div>
    </div>
